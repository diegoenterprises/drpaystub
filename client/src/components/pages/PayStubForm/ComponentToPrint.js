...
const ComponentToPrint = props => {
    ...
    return (
        <div className="w-100" ref={props.parentRef}>
                ...
                <table className="table">
                    <thead style={{ backgroundColor: '#eeeeee' }}>
                        <tr>
                            ...
                            <th scope="col">Social Sec. ID</th>
                            <th scope="col">Employee ID</th>
                            <th scope="col">Check No.</th>
                            <th scope="col">Pay Record</th>
            ...
            <div className="table-responsive">
                <table className="table">
                    <thead style={{ backgroundColor: '#eeeeee', textAlign: 'start' }}>
                        <th>Earning</th>
                        <th>Rate</th>
                        <th>Hours</th>
                        <th>Current</th>
...
export default connect(state => state, {})(ComponentToPrint);
